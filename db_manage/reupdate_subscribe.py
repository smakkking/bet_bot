...
if __name__ == "__main__":
    ...
    a = SQL_DB()
    d = a.SQL_SELECT(select_cond=['sub_end_date', 'chrome_dir_path', 'id'], groups_query=False, where_cond='sub_status=1')
    ...
    a.SQL_UPDATE(set_cond='sub_status=0, sub_end_date=null', where_cond=change_sub_status)